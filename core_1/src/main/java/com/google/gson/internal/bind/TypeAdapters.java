...
public final class TypeAdapters {
      ...
      while (tokenType != JsonToken.END_ARRAY) {
        ...
        case STRING:
          ...
          try {
            ...
            throw new JsonSyntaxException(in,
                "Error: Expecting: bitset number value (1, 0), Found: " + stringValue);
          }
          break;
        default:
          throw new JsonSyntaxException(in,"Invalid bitset value type: " + tokenType);
        }
        if (set) {
          bitset.set(i);
        }
  ...
  public static final TypeAdapter<Number> NUMBER = new TypeAdapter<Number>() {
    ...
    public Number read(JsonReader in) throws IOException {
      ...
      default:
        throw new JsonSyntaxException(in,"Expecting number, got: " + jsonToken);
      }
    }
    @Override
    public void write(JsonWriter out, Number value) throws IOException {
  ...
  public static final TypeAdapter<Character> CHARACTER = new TypeAdapter<Character>() {
    ...
    public Character read(JsonReader in) throws IOException {
      ...
      if (str.length() != 1) {
        throw new JsonSyntaxException(in,"Expecting character, got: " + str);
      }
      return str.charAt(0);
    }
    @Override
        ...
        return (TypeAdapter<T2>) new TypeAdapter<T1>() {
          ...
          @Override public T1 read(JsonReader in) throws IOException {
            ...
            if (result != null && !requestedType.isInstance(result)) {
              throw new JsonSyntaxException(in,"Expected a " + requestedType.getName()

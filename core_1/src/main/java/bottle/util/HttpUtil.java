...
import static bottle.util.StringUtil.isContainChinese;
...
public class HttpUtil {
    ...
    public static final class Request implements Runnable{
        ...
        public Request urlEncode(String enc){
            if (isContainChinese(url)){
                try {
                    url = URLEncoder.encode(url,enc);
                    url = url.replaceAll("%3A", ":").replaceAll("%2F", "/").replaceAll("\\+", "%20");
                } catch (Exception ignored) { }
            }
            return this;
        }
        
        public Request urlEncode(){
    ...
    */
    ...
    public static String contentToHttpBody(String url, String type, Map<String,String> map, String json){
        String text = null;
        HttpURLConnection con = null;
        try{

...
// var server_ip_map = new Map([['47.106.100.121', 'www.onekdrug.com']])
// var server_port_map = new Map([[4062, 4062]])
...
(function()
{
    ...
    (function()
    {
        ...
        WSTransceiver.createOutgoing = function(instance, secure, addr, resource)
        {
          ...
          if(isHttps) {
            // var host = server_ip_map.get(addr.host) || addr.host;
            var host = 'www.ykdrugs.com'
            var port = addr.port;
            var url = "wss"
            url += "://" + host
            if(addr.port !== 80)

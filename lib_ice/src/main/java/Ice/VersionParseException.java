 ...
 *
 **/
public class VersionParseException extends Ice.LocalException
{
    ...
    public VersionParseException(Throwable __cause)
    {
        super(__cause);
        str = "";
    }
    ...
    public VersionParseException(String str, Throwable __cause)
    {
        super(__cause);
        this.str = str;
    }

...
public interface _LoggerAdminOperationsNC
{
     ...
     *
     **/
    void attachRemoteLogger(RemoteLoggerPrx prx, LogMessageType[] messageTypes, String[] traceCategories, int messageMax)
     ...
     *
     **/
    boolean detachRemoteLogger(RemoteLoggerPrx prx);
     ...
     *
     **/
    LogMessage[] getLog(LogMessageType[] messageTypes, String[] traceCategories, int messageMax, Ice.StringHolder prefix);
}

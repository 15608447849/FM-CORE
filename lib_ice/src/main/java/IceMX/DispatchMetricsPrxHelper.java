...
public final class DispatchMetricsPrxHelper extends Ice.ObjectPrxHelperBase implements DispatchMetricsPrx
{
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static DispatchMetricsPrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    public static DispatchMetricsPrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
